...
export function overviewPanel() {
  return `<div class="panel-eyebrow"><span class="status-dot"></span> THE BIG PICTURE <span class="catalog-id">SOL</span></div><h1 id="body-title">Our solar<br>system.</h1><div class="body-type">One star. Countless possibilities.</div><p class="body-description">From the rocky inner worlds to the quiet ice giants, explore our small corner of the universe.</p><div class="overview-stats"><div><strong>4.6<span>B</span></strong><span>YEARS IN THE MAKING</span></div><div><strong>8</strong><span>WORLDS TO DISCOVER</span></div></div><div class="field-note"><div>${icon('orbit')}<span class="eyebrow">A DIFFERENT PERSPECTIVE</span></div><p>Select a world to get closer. Drag to change your perspective, or accelerate time to watch the planets trace their paths.</p></div><button class="primary-button" data-body="earth">${icon('target')}<span>Open Earth</span>${icon('arrow')}</button><div class="panel-footnote">Distances and sizes compressed for exploration</div>`;
}

export function flightPanel() {
  return `<div class="panel-eyebrow"><span class="status-dot"></span> FLIGHT DECK <span class="catalog-id">FREE</span></div><h1 id="body-title">Free flight</h1><div class="body-type">Manual navigation</div><p class="body-description">No destination is selected. Use the flight controls to move through the system, or choose a world from the observatory to set a course.</p><div class="field-note"><div>${icon('ship')}<span class="eyebrow">FLIGHT COMPUTER</span></div><p>Keyboard, mouse, and touch controls are ready. Select a planet whenever you want an assisted approach.</p></div><div class="panel-footnote">No navigation target · Manual flight</div>`;
}
