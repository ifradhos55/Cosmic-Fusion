...
console.log('Main.js loading, THREE:', THREE);

import { OrbitControls } from 'three/addons/controls/OrbitControls.js';
console.log('OrbitControls import ATTEMPTED');
...
try {
    animate();
    console.log('animate() called successfully');
} catch (e) {
    console.error('Error calling animate:', e);
}
